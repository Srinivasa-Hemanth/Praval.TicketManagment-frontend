...
class Header extends React.Component<IHeaderProps,IHeaderState>{
    ...
    render(){
        ...
        return(
            <header className='d-flex align-items-center justify-content-between text-dark p-3'>
              <div>
              ...
              <nav className="navbar">
                <ul className="list-unstyled d-flex gap-4 mb-0">
                  ...
                  <li className="nav-link">
                    <Link to="/my-requests" className="text-decoration-none">
              ...
              <div className="d-flex align me-4 profile-info">
                  <li className="nav-link">
                    <div onClick={this.props.SignIn} className="text-decoration-none">
